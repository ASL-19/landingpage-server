...
AWS_CLOUDFRONT_DISTRIBUTION_ID = os.environ.get(
    'AWS_CLOUDFRONT_DISTRIBUTION_ID', '')
AWS_DEFAULT_ACL = 'public-read'
S3_SSCONFIG_MAX_AGE = os.environ['S3_SSCONFIG_MAX_AGE']
S3_SSCONFIG_BUCKET_NAME = os.environ['S3_SSCONFIG_BUCKET_NAME']
GTF_PROB_WEIGHT = int(os.environ['GTF_PROB_WEIGHT'])
...
PROFILE_DELETE_DELAY = 7

REPUTATION_MAP = [0, 2, 4, 6]
...
# Disable the InsecureRequestWarning warning logs
